// Q1. 다음 조건을 만족하는 Object Type Aliases 만들기
/*
    ...
    Employee는 Academy의 employee속성에서 사용되는 타입별칭입니다.
*/
type Academy = {
    readonly name : "kh"
    class : string[]
...
// Q2. 다음 Object 값을 관리하는 Type별칭 만들기
/*
...
// Q4. 다음 조건을 만족하는 Object Type Aliases을 정의하시오
/*
...
// Q5. 다음 Object 자료의 Type별칭을 정의하시오
/*
...
// Q6. 다음 조건에 만족하는 함수의  매개변수와 매개변수의 타입을 작성하시오
/*
...
function greetUser({name, age, ...others} : {name:string, age:number, [key:string]:string | number}) {
    console.log(`안녕하세요. 제 이름은 ${name} ${age}살 입니다.`); // 안녕하세요. 제이름은 홍길동 30살 입니다.
