...
// 화살표 함수
const declareFn1 = (a,b) => {return a*b}; // 함수표현식
const declareFn2 = (a,b) => a*b;
const declareFn3 = a => a;
...
*/
const arrowFn = () => {
    console.log(this); // global(상위 스코프).this = null
}
const obj2 = {
    name : '객체2',
    arrowFn : arrowFn
...
const obj3 = {
    ...
    arrowFn : function(){
        ...
        console.log(getName()); // 객체3

        const getName2 = function(){
            return this.name; 
        }
        console.log(getName2()); // 글로벌의 this.name = undefined
    }
}
obj3.arrowFn();
